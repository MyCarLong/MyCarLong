...
//
	private static final String defaultSearchURL = "https://search.naver.com/search" +
			".naver?where=nexearch&sm=top_hty&fbm=0&ie=utf8&query=";
//
	...
	public String seleniumTest(@RequestParam("year") String year, @RequestParam("model") String model,
		...
		String cssSelector = "#main_pack > div.sc_new.cs_common_module.case_normal.color_5._cs_car_single > div.cm_content_wrap._content > div > div > div > div:nth-child(1) > div.movie_photo_list.type_absolute > ul > li:nth-child(1)";
