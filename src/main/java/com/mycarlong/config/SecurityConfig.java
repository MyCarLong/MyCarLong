...
public class SecurityConfig  {
	...
	public SecurityConfig(UserService userService, CustomSuccessHandler customSuccessHandler, JWTUtil jwtUtil,
	                      JWTFilter jwtFilter) {
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		http.authorizeHttpRequests(authorizeRequests -> authorizeRequests
				                           .requestMatchers("/", "/aboutus", "/api/**",
				                                            "/oauth/**", "/car/**", "/image/**"
						                           , "/loggedinserinfo", "/board/**", "/isServerOn", "/images/**"
				                                           ).permitAll()
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.setAllowedOrigins(Arrays.asList("https://openapi.naver.com/v1/nid/me",
